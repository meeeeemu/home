...
function initBackground(){
    ...
    const displacement = loader.load("/textures/displace_map.jpg");
    const displacementRev = loader.load("/textures/displace_map_rev.jpg");
    const alphaMap = loader.load("/textures/alpha_map.jpg");
    const planeTexture = loader.load("/textures/square.png")
